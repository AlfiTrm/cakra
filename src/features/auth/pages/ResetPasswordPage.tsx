          ...
          <div className="flex flex-1 items-center py-8">
            <div className="w-full max-w-[480px]">
              ...
              <form className="mt-8 grid gap-4" onSubmit={handleSubmit}>
                <AuthInput label="Masukkan password baru" placeholder="Masukkan password baru" type="password" />
                <AuthInput label="Konfirmasi password baru" placeholder="Konfirmasi password baru" type="password" />
